...
final List<QuestStep> eldenRingQuests = [
  ...
  QuestStep(
    ...
    region: 'Limgrave',
    description:
        'Defeat Margit at the entrance to Stormveil Castle.',
    warnings: [],
    affects: ['Main Story'],
    requires: ['meet_melina'],
  ),
  ...
  QuestStep(
    ...
    region: 'Limgrave',
    description:
        'Defeat Godrick inside Stormveil Castle.',
    warnings: [],
  ...
  QuestStep(
    ...
    region: 'Limgrave',
    description:
        'Hear Blaidd\'s howl in Mistwood and speak with him after learning how to call him down.',
    warnings: [],
  ...
  QuestStep(
    ...
    region: 'Caelid',
    description:
        'Travel to Redmane Castle and defeat Starscourge Radahn.',
    warnings: [
  ...
  QuestStep(
    ...
    region: 'Nokron',
    description:
        'Enter the newly accessible underground city of Nokron.',
    warnings: [],
    affects: ['Ranni', 'Blaidd'],
  ...
  QuestStep(
    ...
    warnings: [
      'Giving Ranni the Fingerslayer Blade advances her questline.'
    ],
    affects: ['Ranni', 'Blaidd', 'Seluvis'],
  ...
  QuestStep(
    ...
    region: 'Leyndell',
    description:
        'Reach the Elden Throne and defeat Morgott.',
    warnings: [
